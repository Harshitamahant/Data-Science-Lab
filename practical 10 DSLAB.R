...
if (p_one_sided < alpha) {
  cat("\nDecision: Reject H0 — evidence the program causes weight loss (mean > 0).\n")
} else {
  cat("\nDecision: Fail to reject H0 — no significant evidence of weight loss.\n")
}